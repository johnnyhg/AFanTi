		  ...
		  protected DataModel buildModel() throws IOException {
		    ...
		    if (hasPrefValues) {
		      ...
		      if (loadFreshData) {
		        ...
		        return new NewGenericDataModel(NewGenericDataModel.toDataMap(data, true), timestamps);

		      } else {

		        FastByIDMap<PreferenceArray> rawData = ((NewGenericDataModel) delegate).getRawUserData();
		        ...
		        return new NewGenericDataModel(rawData, timestamps);
