...
public class testKNNeighborhoodSelecter {
	...
	public static void main(String[] str) {
		...
		KNNeighborhoodSelecter neighborhoodSelector = new KNNeighborhoodSelecter(SimilarityComputer,myDataModel,10);
		...
		Neighborhood[] neighborhoods=neighborhoodSelector.getNeighborhoodsOfItem(itemV1, 1);
